F = 5 # Every f minutes solves a matching problem to prescribe the next pick-up and delivery assignment for each courier
...
X = 40 # the number of minutes that is considered a long waiting time
